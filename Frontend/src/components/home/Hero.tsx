        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <form onSubmit={handleSearch} className="bg-white rounded-2xl shadow-xl p-6 space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-3 px-6 rounded-xl hover:from-blue-700 hover:to-purple-700 transform hover:-translate-y-0.5 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center group relative z-10 btn-fix"
              >
                Find NGOs & Programs
            ...
            <div className="flex flex-wrap gap-4 relative z-20">
              <Link
                to="/volunteer"
                className="inline-flex items-center px-6 py-3 bg-white text-blue-600 font-semibold rounded-xl shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all border border-blue-200 btn-fix"
              >
              ...
              <Link
                to="/ngos"
                className="inline-flex items-center px-6 py-3 bg-purple-600 text-white font-semibold rounded-xl shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all hover:bg-purple-700 btn-fix"
              >
